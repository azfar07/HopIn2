...
class FakeDB {
  static RidesModel fakeRide = new RidesModel(
      fromText: 'from',
      toText: 'to',
      ...
      driver: fakeUser);
  static UserModel fakeUser = new UserModel(
      name: 'name',
      gender: Gender.male,
      phone: '699999999',
      email: 'covid19@gmail.com',
      carInfo: 'mercedes bench',
      rating: 1.1);
  static ReviewModel reviewModel = new ReviewModel(
  ...
  static final RidesModel ride55 = RidesModel(
    randPoints: [
      new LatLng(38.236785, 23.94523),
      new LatLng(38.324466, 23.844654),
      new LatLng(38.787454, 23.563211),
      new LatLng(37.67887, 23.454545),
      new LatLng(37.67887, 22.45)
    ],
